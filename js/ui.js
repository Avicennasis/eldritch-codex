...
import { getState, update, updateNested, resetAll } from './state.js?v=21';
import * as dice from './dice.js?v=6';
import { logRoll, renderLog, doClearLog } from './log.js?v=6';
import { shortRest, longRest } from './rest.js?v=15';
